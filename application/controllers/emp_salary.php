...
class Emp_salary extends CI_controller{
	...
	function emp_salary_details_list(){
		...
		if(! $this->session->userdata('username'))
		{
			...
			//$data['emp_salary_details_list'] = $this->emp_salary_model->emp_salary_details_list();
			$data['employee_department_details_list'] = $this->Employee_department_model->employee_department_details_list();
			$this->load->view('emp_salary_details_list', $data);
		}
	}
