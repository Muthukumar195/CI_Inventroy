				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Bank Details</h4>
						</div>
				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Bank Detailes</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
                        ...
                        <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                <li class="active"><a href="#bottom-justified-tab1" data-toggle="tab"><b>Bank Details</b></a></li>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="text-right">
                                        <strong id="batch_year" class="text-violet"></strong>
                                        </div>
                                        </div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-lg-2">Bank Name<span class="req">*</span>:</label>
                                        <div class="col-lg-10">
										 <?php
											...
											'IndusInd Bank Limited' => 'IndusInd Bank Limited',
											'ICICI Bank' => 'ICICI Bank',
											'ING Vysya Bank' => 'ING Vysya Bank',
											'Kotak Mahindra Bank Limited' => 'Kotak Mahindra Bank Limited',
											'Karnataka Bank' => 'Karnataka Bank',
											'Karur Vysya Bank Limited' => 'Karur Vysya Bank Limited',
											'Tamilnad Mercantile Bank Ltd' => 'Tamilnad Mercantile Bank Ltd',
											'The Dhanalakshmi Bank Limited' => 'The Dhanalakshmi Bank Limited',
											'The Federal Bank Ltd' => 'The Federal Bank Ltd',
											'The HDFC Bank Ltd' => 'The HDFC Bank Ltd',
											'The Jammu & Kashmir Bank Ltd' => 'The Jammu & Kashmir Bank Ltd',
											'The Nainital Bank Ltd' => 'The Nainital Bank Ltd',
											'The Lakshmi Vilas Bank Ltd' => 'The Lakshmi Vilas Bank Ltd',
											'Yes Bank' => 'Yes Bank',
											); 
                                        echo form_dropdown('bank_name', $option_bank, '', 'class="form-control" id="bank_name"');
                                        ?>
                                        </div>
									</div>
