			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Add Purchase order</h4>
						</div>
				...
				<div class="content">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Purchase Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('purchase_details/validate_purchse_details', array('class'=>'')); ?>
																	...
																	<thead class="bordered">
																		<tr role="row">
																			...
																			<tr>
																				...
																				<td>
																					<select class="form-control" name="product_id[]" id="product_id[]" onChange="get_purchase_val(this.value,0);">
...
include("validation/add_purchase_details.php");
...
$(document).ready(function(){
	...
	<script>
			...
			$(".addmore").on('click',function(){
				...
				data +='<td class="col-md-2 form-group"><select class="form-control" name="product_id[]" id="product_id'+i+'"  onchange="get_purchase_val(this.value,'+i+');"><option value="" >Select</option><?php foreach($product_name_list->result() as $pdt){ ?><option value="<?php echo $pdt->Product_id; ?>"><?php echo $pdt->Product_name; ?></option><?php } ?></select></td>';
				data +='<td><textarea class="form-control" rows="1" name="description[]" id="description'+i+'"></textarea></td>';
				data +='<td class="form-group"><input type="text" class="form-control" name="quantity[]" id="quantity'+i+'" onblur="cal_amount('+i+');"/></td>';
			...
			//purchase rate get
			function get_purchase_val(val,id){
				var value = val;
				if(value!=0){
					$.ajax({
						url: '<?php echo base_url(); ?>/index.php/product_details/get_pur_prd_details',
						type: 'GET',
						data: { val: val },
						success: function(result){
							document.getElementById('rate'+id).value=result;
						}
			   });
