...
populateCountries("country2");
				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-pencil6"></i>&nbsp;<strong>Edit Employee Department Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('employee_department/validate_edit_employee_department', array('class'=>'form-horizontal')); ?>
                             <span style="color:red; "><?php echo validation_errors(); ?></span> 
                             	<?php foreach($employee_department_data->result() as $row){ ?>
									...
									<div class="form-group">
										...
										<div>
											...
											$data1 = array(
												...
												'value'       => $row->Employee_department_name,
												'class'       => 'form-control text-capitalize text-semibold',
												'placeholder' => 'Enter Department Name',											
											);
											echo form_input($data1);
											?>
                                            <input type="hidden" name="id" value="<?php echo $row->Employee_department_id; ?>">
										</div>
									</div>  
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Department Details List</h5>
                                <div class="heading-elements">
                                    <ul class="icons-list">
    ...
    <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($employee_department_data->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                        <td><?php echo $row->Employee_department_name; ?></td>
                                        <td>
										<?php 
                                        if($row->Employee_department_status=="A"){
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="edit_batch_details?id=<?php echo $row->Employee_department_id; ?>" class="text-info"><i class="icon-pen6"></i> Edit</a></li>
                                                        <li>
														<?php 
                                                        if($row->Employee_department_status=="A"){
                                                        echo '<a href="deny?id='.$row->Employee_department_id.'" class="text-danger"><i class="icon-cross3"></i>Deny</a>';
                                                        }
                                                        else{
                                                            echo '<a href="approve?id='.$row->Employee_department_id.'" class="text-success"><i class="icon-checkmark2"></i>Active</a>';
                                                        }
                                                        ?>
                                                        </li>
