				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Purchase Details</h4>
						</div>

						<div class="heading-elements">
							<div class="heading-btn-group">
								<a  class="btn btn-link btn-float has-text" data-toggle="modal" data-target="#purchase_payment"><i class="icon-bars-alt text-primary"></i><span>Payments</span></a>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Purchase Details List</h5>
							<div class="heading-elements">
								<ul class="icons-list">
            ...
            <div class="modal-content">
              ...
              <?php
							$sno=1; $paid=''; $balance=''; $total='';
 							foreach($purchase_details_list->result() as $row){ ?>
								<tr>
                    <td><?php echo $sno; ?></td>
					          <td><?php echo date('d-m-Y', strtotime($row->Purchase_date)); ?></td>
                    <td><?php echo $row->Customer_name; ?></td>
					          <td><?php echo $row->Purchase_cus_type; ?></td>
					          <td><?php echo $row->Purchase_invoice_no; ?></td>
					          <td class="alpha-green"><?php $paid += $row->Purchase_paid; if($row->Purchase_paid!="") { echo  number_format($row->Purchase_paid); } ?></td>
                    <td  class="alpha-orange"><?php  $balance += $row->Purchase_balance; if($row->Purchase_balance!="") { echo number_format($row->Purchase_balance); } ?></td>
                    <td class="alpha-blue"><?php $total +=$row->Purchase_total;  if($row->Purchase_total!="") { echo  number_format($row->Purchase_total); } ?></td>
									  <td class="text-center">
                    <ul class="my-list list-inline">
                        <li><a href="view_purchase_details?id=<?php echo $row->Purchase_id; ?>"><span style="padding: 2px 6px;" class="label label-success"> View</span></a></li>
                        <li><a href="delete?id=<?php echo $row->Purchase_id; ?>" onclick="return confirm('Are you sure you want to delete?')"><span style="padding: 2px 6px;" class="label label-danger"> DELETE</span></a></li>
...
<script>
  ...
  $(document).ready(function(){
    $('#cus_id').change(function(){
      ...
      $.ajax({
        type : "GET",
        url  : "<?php echo base_url(); ?>/index.php/purchase_details/get_cus_payment_details",
...
<div id="purchase_payment" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-success">
									...
									<?php echo form_open_multipart('purchase_details/customer_payment', array('name'=>'purchase_payment')); ?>
