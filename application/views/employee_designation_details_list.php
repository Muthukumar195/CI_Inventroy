				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Employee Designation Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('employee_designation/validate_employee_designation_details', array('class'=>'form-horizontal')); ?>
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Employee Designation Details List</h5>
                                <div class="heading-elements">
                                    <ul class="icons-list">
                           ...
                           <!-- <div class="panel-body">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($employee_designation_details_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="edit_employee_designation_details?id=<?php echo $row->Employee_designation_id; ?>" class="text-info"><i class="icon-pen6"></i> Edit</a></li>
                                                        <li>
														<?php 
                                                        if($row->Employee_designation_status=="A"){
