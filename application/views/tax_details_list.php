			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Tax Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('tax_details/validate_tax_details', array('class'=>'')); ?>
                  ...
                  <div class="col-md-6"> 
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-responsive">
                            ...
                            <?php 
							$sno=1;
							foreach($tax_details_list->result() as $row){ ?>
								<tr>
                                	<td><?php echo $sno; ?></td>
...
include("validation/tax_details_list.php"); 
