					...
					<div class="footer text-muted">
						&copy; 2016. <a href="#">School Management Software</a> Developed by <a href="http://daffodillstechnologies.com" target="_blank">Daffodills India Technologies</a>
					</div>
					<!-- /footer -->
   ...
   <!-- Theme JS files -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/zebra_datepicker/zebra_datepicker.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/zebra_datepicker/core.js"></script>    	
