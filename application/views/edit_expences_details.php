		...
		<div class="page-content">
            ...
            <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-pencil6"></i>&nbsp;<strong>Edit Expences Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('expences_details/validate_edit_expences', array('class'=>'form-horizontal')); ?>
                             <span style="color:red; "><?php echo validation_errors(); ?></span>
                             	<?php foreach($ex_details_data->result() as $row){ ?>
															<fieldset class="content-group">
																<div class="form-group">
																		<label>joining Date :</label>
																			...
																			?>
																			<input name="id" value="<?php echo  $row->Exp_id?>" type="hidden">
																		</div>
																	</div>
																<div class="form-group">
																	...
																	<div>
																		<?php
																			 foreach($expences_master_name_list->result() as $ex_mas) {
																				$option_other[$ex_mas->Exp_mas_id] = $ex_mas->Exp_mas_name;
																			 }
																			 echo form_dropdown('Exp_master_id', $option_other, $row->Exp_mas_id, 'class="form-control"')
																			 ?>
																	</select>
																	</div>
																</div>
																	...
																	<a href="#" id="adv1" name="adv1" onClick="adv_fun('adv1');" style="display:none;"><i class="icon-subtract"></i>&nbsp;Advanced option</a>
																		<div id="advance" style="display:none;">
																			<div class="form-group">
																				...
																				<?php  echo $method = $row->Exp_method ?>
																					<select id="methods" name="methods" class="form-control" style="width:100%;">
																						<option value="">Select Payment Methods</option>
																						<option value="cheque" <?php if($method=='cheque'){ echo "selected"; }?>>cheque</option>
																						<option value="DD" <?php if($method=='DD'){ echo "selected"; }?>>DD</option>
																			...
																			<div class="form-group">
																				<label>Ref#</label>
																					<input type="text" name="ref"  id="ref" class="form-control" value="<?php echo $row->Exp_ref; ?>" >
                        ...
                        <div class="col-md-6">
                           ...
                           <!-- <div class="panel-body">
														...
														<table class="table datatable-responsive">
																...
																<?php
																$sno=1;
																foreach($ex_details_data->result() as $row){ ?>
																		<tr>
																				<td><?php echo $sno; ?></td>
